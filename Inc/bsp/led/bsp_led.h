...
#define LED3_ON                       HAL_GPIO_WritePin(LED3_GPIO,LED3_GPIO_PIN,GPIO_PIN_RESET)    // 输出高电平
#define LED3_OFF                      HAL_GPIO_WritePin(LED3_GPIO,LED3_GPIO_PIN,GPIO_PIN_SET)  // 输出低电平
#define LED3_TOGGLE                   HAL_GPIO_TogglePin(LED3_GPIO,LED3_GPIO_PIN)                // 输出反转

#define LED4_ON                       HAL_GPIO_WritePin(LED4_GPIO,LED4_GPIO_PIN,GPIO_PIN_RESET)    // 输出高电平
#define LED4_OFF                      HAL_GPIO_WritePin(LED4_GPIO,LED4_GPIO_PIN,GPIO_PIN_SET)  // 输出低电平
